...
import { useGetOrderFromNewApiQuery, useGetOrderItemsFromNewApiQuery, Order } from '../../../../ECommerceApi';
						...
						<div className='flex justify-between'>
							<div>
								...
								<Typography
									...
									className='mb-2'
								>
									Payment Method: {currentOrder.payment_method.toUpperCase().replace('_', ' ')}
								</Typography>
								{currentOrder.tracking_number && (
									<Typography
										...
										className='mb-2'
									>
										Tracking: {currentOrder.tracking_number}
									</Typography>
								)}
							</div>
												...
												<TableRow key={item.item_id || index}>
													<TableCell>
														<div>
															...
															>
																{(item as unknown as OrderItemWithProduct)
											...
											<TableRow>
												<TableCell>
													<Typography variant='subtitle1'>
														Order Items (Order ID: {currentOrder.order_id})
													</Typography>
													<Typography
														variant='body2'
														color='text.secondary'
							...
							<div className='flex items-start'>
								...
								<div className='px-24'>
									...
									<Typography
										...
										color='text.secondary'
									>
										Order Status: {currentOrder.order_status.toUpperCase().replace('_', ' ')}
									</Typography>
									<Typography
										className='font-normal'
										variant='caption'
