...
function GenderWidget() {
	...
	if (awaitRender || !widget?.series || !widget?.labels || widget?.uniqueVisitors === undefined) {
		return (
	...
	return (
		<Paper className='flex flex-col flex-auto shadow rounded-xl overflow-hidden p-16'>
			<div className='flex flex-col sm:flex-row items-start justify-between'>
				<Typography className='text-lg font-medium tracking-tight leading-6 truncate'>{t('Gender')}</Typography>
				<div className='ml-8'>
					<Chip
						size='small'
